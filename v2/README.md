<p align="center">
  ...
  <p align="center">
    <a href="https://pkg.go.dev/github.com/emberot/go-paginate/v2"><img alt="Reference" src="https://img.shields.io/badge/go-reference-purple?style=for-the-badge"></a>
...
1. **Import the package:**
   ...
   ```go
   import "github.com/emberot/go-paginate/v2/paginate"
   ```
...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/emberot/go-paginate/blob/master/LICENSE) file for details
